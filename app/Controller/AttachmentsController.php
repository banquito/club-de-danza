 ...
 */
	public function add() {
		...
		$auditions = $this->Attachment->Audition->find('list');
		$calls = $this->Attachment->Call->find('list');
		$castings = $this->Attachment->Casting->find('list');
		$jobs = $this->Attachment->Job->find('list');
		$this->set(compact('auditions', 'calls', 'castings', 'jobs'));
	}
