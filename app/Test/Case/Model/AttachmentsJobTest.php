<?php
App::uses('AttachmentsJob', 'Model');

/**
 * AttachmentsJob Test Case
 *
 */
class AttachmentsJobTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AttachmentsJob = ClassRegistry::init('AttachmentsJob');
	}
