<?php
App::uses('AttachmentsAuditionsController', 'Controller');

/**
 * AttachmentsAuditionsController Test Case
 *
 */
class AttachmentsAuditionsControllerTest extends ControllerTestCase {
