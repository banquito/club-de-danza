<?php
App::uses('AttachmentsCastingsController', 'Controller');

/**
 * AttachmentsCastingsController Test Case
 *
 */
class AttachmentsCastingsControllerTest extends ControllerTestCase {
