...
<div class="row">
	...
	<div class="col-sm-6">
		...
		<div class="row">
			<div class="col-sm-12">
				<?php if(isset($accessory['Photo']) && sizeof($accessory['Photo']) > 0): ?>
					<div id="slider-photo" class="carousel slide" data-ride="carousel">
						...
						<ol class="carousel-indicators">
					    	...
					    	<?php foreach ($accessory['Photo'] as $key => $photo): ?>
						...
						<div class="carousel-inner">
							<div class="item active">
								<?php echo $this->Html->image('accessories/'.$accessory['Accessory']['image'], array('class'=>'image-center'));?>
					            <div class="carousel-caption">
					            	<h3>
					                	<a><?php echo $accessory['Accessory']['image']; ?></a>
									</h3>
					            </div>
							</div>
							<?php foreach ($accessory['Photo'] as $key => $photo): ?>
