<div class="jobsPhotos index">
	<h2><?php echo __('Jobs Photos'); ?></h2>
	...
	<?php foreach ($jobsPhotos as $jobsPhoto): ?>
	<tr>
		...
		<td><?php echo h($jobsPhoto['JobsPhoto']['created']); ?>&nbsp;</td>
		<td><?php echo h($jobsPhoto['JobsPhoto']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($jobsPhoto['User']['name'], array('controller' => 'users', 'action' => 'view', $jobsPhoto['User']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $jobsPhoto['JobsPhoto']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $jobsPhoto['JobsPhoto']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $jobsPhoto['JobsPhoto']['id']), null, __('Are you sure you want to delete # %s?', $jobsPhoto['JobsPhoto']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
