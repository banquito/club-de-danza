<div class="accessoriesDancestyles index">
	<h2><?php echo __('Accessories Dancestyles'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('modified'); ?></th>
			<th><?php echo $this->Paginator->sort('accessories_id'); ?></th>
			<th><?php echo $this->Paginator->sort('dancestyle_id'); ?></th>
			<th><?php echo $this->Paginator->sort('user_id'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($accessoriesDancestyles as $accessoriesDancestyle): ?>
	<tr>
		<td><?php echo h($accessoriesDancestyle['AccessoriesDancestyle']['id']); ?>&nbsp;</td>
		<td><?php echo h($accessoriesDancestyle['AccessoriesDancestyle']['created']); ?>&nbsp;</td>
		<td><?php echo h($accessoriesDancestyle['AccessoriesDancestyle']['modified']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $accessoriesDancestyle['AccessoriesDancestyle']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $accessoriesDancestyle['AccessoriesDancestyle']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $accessoriesDancestyle['AccessoriesDancestyle']['id']), null, __('Are you sure you want to delete # %s?', $accessoriesDancestyle['AccessoriesDancestyle']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
