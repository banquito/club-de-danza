<?php 
echo $this->Html->css('slidernotes/edit', '', array('inline'=>FALSE));
?>

<div class="row row-header-h1">
	<div class="col-sm-12">
		<h1><?php echo __('Edit Slidernote'); ?></h1>
	</div>
</div>

<div class="row">
	<div class="col-sm-12">
		<?php echo $this->Form->create('Slidernote', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')) ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<?php	echo $this->Form->input('title', array(
						'class' => 'form-control',
						'label' => false,
						'placeholder' => __('Slidernote title (max.: 50 characters)'),
						'required' => 'required',
						'maxlength' => 50,
						'type' => 'text'
					));
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row row-image-name">
						<div class="col-sm-12">
							<span class="label <?php echo ($this->request->data['Slidernote']['image']) ? 'label-primary' : 'label-danger'; ?>">
								<?php echo ($imageName = $this->request->data['Slidernote']['image']) ? $imageName : __('No image'); ?>
							</span>
						</div>
					</div>
					<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-sm-offset-4 col-sm-2">
					<a href="/slidernotes" class="btn btn-default"><?php echo __('Cancelar'); ?></a>
				</div>
			</div>
