...
<?php echo $this->Form->create('CastingsProfession'); ?>
	<fieldset>
		<legend><?php echo __('Edit Castings Profession'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CastingsProfession.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CastingsProfession.id'))); ?></li>
