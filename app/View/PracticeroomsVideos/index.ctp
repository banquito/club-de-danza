<div class="practiceroomsVideos index">
	<h2><?php echo __('Practicerooms Videos'); ?></h2>
	...
	<?php foreach ($practiceroomsVideos as $practiceroomsVideo): ?>
	<tr>
		<td><?php echo h($practiceroomsVideo['PracticeroomsVideo']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($practiceroomsVideo['PracticeroomsVideo']['created']); ?>&nbsp;</td>
		<td><?php echo h($practiceroomsVideo['PracticeroomsVideo']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($practiceroomsVideo['User']['name'], array('controller' => 'users', 'action' => 'view', $practiceroomsVideo['User']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $practiceroomsVideo['PracticeroomsVideo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $practiceroomsVideo['PracticeroomsVideo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $practiceroomsVideo['PracticeroomsVideo']['id']), null, __('Are you sure you want to delete # %s?', $practiceroomsVideo['PracticeroomsVideo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
