...
<div class="row row-header-h1">
	<div class="col-sm-12">
		<h1><?php echo __('Edit Job'); ?></h1>
	</div>
</div>

<div class="row">
	<div class="col-sm-12">
		<?php echo $this->Form->create('Job', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')) ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row row-image-name">
						<div class="col-sm-12">
							<span class="label <?php echo ($this->request->data['Job']['image']) ? 'label-primary' : 'label-danger'; ?>">
								<?php echo ($imageName = $this->request->data['Job']['image']) ? $imageName : __('No image'); ?>
							</span>
						</div>
					</div>
					<div class="row">
			...
			<div class="form-group">
				<label for="element-date" class="col-sm-4 control-label"><?php echo __('Job date'); ?></label>
				<div class="col-sm-8">
					<div class='input-group date' id='datetimepickerJob'>
							...
							<?php if(isset($this->request->data['Attachment']) && sizeof($this->request->data['Attachment']) > 0): ?>
									<?php foreach ($this->request->data['Attachment'] as $key => $attachment): ?>
										<span class="label label-primary"><?php echo $attachment['name']; ?> | 
											<?php
											echo $this->Html->Link('x'
												, array('controller' => 'AttachmentsJobs'
													, 'action' => 'remove'
													, $attachment['AttachmentsJob']['id']
												)
											);
											?></span>
										&nbsp;
