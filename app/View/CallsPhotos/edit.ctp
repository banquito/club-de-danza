<div class="callsPhotos form">
<?php echo $this->Form->create('CallsPhoto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Calls Photo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CallsPhoto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CallsPhoto.id'))); ?></li>
