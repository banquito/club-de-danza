<div class="castingsPhotos form">
<?php echo $this->Form->create('CastingsPhoto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Castings Photo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CastingsPhoto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CastingsPhoto.id'))); ?></li>
