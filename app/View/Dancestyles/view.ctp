<div class="dancestyles view">
<h2><?php echo __('Dancestyle'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($dancestyle['Dancestyle']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($dancestyle['Dancestyle']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($dancestyle['Dancestyle']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($dancestyle['Dancestyle']['modified']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Dancestyle'), array('action' => 'edit', $dancestyle['Dancestyle']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Dancestyle'), array('action' => 'delete', $dancestyle['Dancestyle']['id']), null, __('Are you sure you want to delete # %s?', $dancestyle['Dancestyle']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($dancestyle['Audition'])): ?>
	...
	<?php foreach ($dancestyle['Audition'] as $audition): ?>
		<tr>
