...
<?php echo $this->Form->create('AuditionsDancestyle'); ?>
	<fieldset>
		<legend><?php echo __('Edit Auditions Dancestyle'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AuditionsDancestyle.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AuditionsDancestyle.id'))); ?></li>
