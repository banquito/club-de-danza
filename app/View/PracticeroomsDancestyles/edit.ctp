...
<?php echo $this->Form->create('PracticeroomsDancestyle'); ?>
	<fieldset>
		<legend><?php echo __('Edit Practicerooms Dancestyle'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PracticeroomsDancestyle.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PracticeroomsDancestyle.id'))); ?></li>
