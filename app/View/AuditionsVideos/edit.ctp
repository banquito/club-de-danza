...
<?php echo $this->Form->create('AuditionsVideo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Auditions Video'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AuditionsVideo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AuditionsVideo.id'))); ?></li>
