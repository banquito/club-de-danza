...
<?php echo $this->Form->create('AttachmentsAudition'); ?>
	<fieldset>
		<legend><?php echo __('Edit Attachments Audition'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AttachmentsAudition.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AttachmentsAudition.id'))); ?></li>
