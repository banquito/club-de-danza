...
<?php echo $this->Form->create('Bannercategory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bannercategory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Bannercategory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Bannercategory.id'))); ?></li>
