<div class="professions index">
	...
	<tr>
		...
		<td><?php echo h($profession['Profession']['created']); ?>&nbsp;</td>
		<td><?php echo h($profession['Profession']['modified']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($profession['User']['name'], array('controller' => 'users', 'action' => 'view', $profession['User']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $profession['Profession']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $profession['Profession']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $profession['Profession']['id']), null, __('Are you sure you want to delete # %s?', $profession['Profession']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
