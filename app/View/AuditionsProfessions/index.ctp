<div class="auditionsProfessions index">
	<h2><?php echo __('Auditions Professions'); ?></h2>
	...
	<?php foreach ($auditionsProfessions as $auditionsProfession): ?>
	<tr>
		<td><?php echo h($auditionsProfession['AuditionsProfession']['id']); ?>&nbsp;</td>
		<td><?php echo h($auditionsProfession['AuditionsProfession']['created']); ?>&nbsp;</td>
		<td><?php echo h($auditionsProfession['AuditionsProfession']['modified']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $auditionsProfession['AuditionsProfession']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $auditionsProfession['AuditionsProfession']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $auditionsProfession['AuditionsProfession']['id']), null, __('Are you sure you want to delete # %s?', $auditionsProfession['AuditionsProfession']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
