<div class="auditionsProfessions form">
<?php echo $this->Form->create('AuditionsProfession'); ?>
	<fieldset>
		<legend><?php echo __('Edit Auditions Profession'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AuditionsProfession.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AuditionsProfession.id'))); ?></li>
